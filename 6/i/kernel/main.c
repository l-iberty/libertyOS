...
/*		_printf("-----TaskA-----");*/
/*		*/
/*		fd1 = open("/taska-1", O_CREAT);*/
/*		fd2 = open("/taska-2", O_CREAT);*/
/*		if (fd1 != -1 && fd2 != -1) {*/
/*			close(fd1);*/
/*			close(fd2);*/
/*		*/
/*			fd1 = open("/taska-1", O_RDWR);*/
/*			fd2 = open("/taska-2", O_RDWR);*/

/*			_printf("\n>> test-1");*/
/*			char buf[SECTOR_SIZE*4-0x10];*/
/*			for (i = 0; i < sizeof(buf); i++) {*/
/*				buf[i] = 'A';*/
/*			}*/
/*			nr_bytes = write(fd1, buf, sizeof(buf));*/
/*			_printf("\n[fd: %.4x] bytes written: %.4x", fd1, nr_bytes);*/
/*			close(fd1);*/

/*			_printf("\n>> test-3");*/
/*			fd1 = open("/taska-1", O_RDWR);*/
/*			p_current_proc->filp[fd1]->fd_pos = 16;*/
/*			for (i = 0; i < sizeof(buf); i++) {*/
/*				buf[i] = '+';*/
/*			}*/
/*			nr_bytes = write(fd1, buf, sizeof(buf));*/
...
/*			int bytes_tol = 0;*/
/*			for (i = 0; i < sizeof(buf); i++) {*/
/*				nr_bytes = write(fd2, "p", sizeof(char));*/
/*				bytes_tol += nr_bytes;*/
/*			}*/
/*			_printf("\n[fd: %.4x] bytes written: %.4x", fd2, bytes_tol);*/
/*		*/
/*			close(fd1);*/
/*			close(fd2);*/
/*		}*/
...
void TaskB()
{
	for (;;)
	{
		...
		fd = open("/taska-1", O_RDWR);
		if (fd != -1) {
/*			_printf("\n>> test-1");*/
/*			//__asm__("ud2");*/
/*			nr_bytes = read(fd, buf, 32);*/
/*			_printf("\n[fd: %.4x] bytes read: %.4x", fd, nr_bytes);*/
/*			close(fd);*/

/*			_printf("\n>> test-2");*/
/*			//__asm__("ud2");*/
/*			nr_bytes = read(fd, buf, SECTOR_SIZE*32);*/
/*			_printf("\n[fd: %.4x] bytes read: %.4x", fd, nr_bytes);*/
/*			close(fd);*/
...
/*				bytes_tol += nr_bytes;*/
/*			}*/
/*			_printf("\n[fd: %.4x] bytes read totally: %.4x", fd, bytes_tol);*/
/*			close(fd);*/
			
			_printf("\n>> test-4");
			p_current_proc->filp[fd]->fd_pos = 16;
			nr_bytes = read(fd, buf, SECTOR_SIZE*32);
			_printf("\n[fd: %.4x] bytes read: %.4x", fd, nr_bytes);
			close(fd);
		}
