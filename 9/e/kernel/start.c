...
void cstart() {
  ...
  /* 8259A */
  init_idt_desc(IDT, INT_VECTOR_IRQ00, SELECTOR_FLATC, (uint32_t)hwint_0, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ01, SELECTOR_FLATC, (uint32_t)hwint_1, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ02, SELECTOR_FLATC, (uint32_t)hwint_2, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ03, SELECTOR_FLATC, (uint32_t)hwint_3, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ04, SELECTOR_FLATC, (uint32_t)hwint_4, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ05, SELECTOR_FLATC, (uint32_t)hwint_5, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ06, SELECTOR_FLATC, (uint32_t)hwint_6, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ07, SELECTOR_FLATC, (uint32_t)hwint_7, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ08, SELECTOR_FLATC, (uint32_t)hwint_8, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ09, SELECTOR_FLATC, (uint32_t)hwint_9, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ10, SELECTOR_FLATC, (uint32_t)hwint_10, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ11, SELECTOR_FLATC, (uint32_t)hwint_11, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ12, SELECTOR_FLATC, (uint32_t)hwint_12, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ13, SELECTOR_FLATC, (uint32_t)hwint_13, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ14, SELECTOR_FLATC, (uint32_t)hwint_14, DA_386IGATE);

  init_idt_desc(IDT, INT_VECTOR_IRQ15, SELECTOR_FLATC, (uint32_t)hwint_15, DA_386IGATE);

  /* system call */
  init_idt_desc(IDT, INT_VECTOR_SYSCALL, SELECTOR_FLATC, (uint32_t)sys_call, DA_386IGATE | DPL_3);
