...
void kernel_main()
{
	...
	proc_table[0].ticks = proc_table[0].priority = MAX_PRIORITY >> 1;
	proc_table[1].ticks = proc_table[1].priority = MAX_PRIORITY >> 1;
	proc_table[2].ticks = proc_table[2].priority = MAX_PRIORITY >> 1;
	proc_table[3].ticks = proc_table[3].priority = MAX_PRIORITY;
	proc_table[4].ticks = proc_table[4].priority = MAX_PRIORITY;
	proc_table[5].ticks = proc_table[5].priority = MAX_PRIORITY;
